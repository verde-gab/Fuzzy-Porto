...
A Tabela~\ref{tab:ms-tests} apresenta os resultados da bateria de testes de \textit{misspecification} aplicada aos resíduos da regressão linear.
...
\begin{enumerate}
    ...
    \item O \textbf{PWFTS sobre $\Delta_{12}y$} (diferença sazonal, ordem 3) é o modelo que passa limpo em todas as defasagens testadas, representando o caso mais forte de adequação residual dentre os modelos fuzzy avaliados.
\end{enumerate}
